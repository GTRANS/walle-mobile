  ...
  void getPulsa() {
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      Provider.of<ProductViewModel>(context, listen: false)
          .get(categoryId: 1, providerId: providerId!);
    });
  }
                  ...
                  child: TextFormField(
                    onChanged: (value) {
                      if (value.length >= 4) {
                        ...
                        final List<String> indosat = [
                          '0857',
                          '0856',
                        ];
                        final List<String> smartfren = [
                          '0881',
                          '0882',
                          '0883',
                          '0884',
                        ...
                        if (axis.contains(code)) {
                          ...
                          providerId = 1;
                        } else if (telkomsel.contains(code)) {
                          provider = 'assets/telkomsel.png';
                          providerId = 6;
                        } else if (indosat.contains(code)) {
                          provider = 'assets/indosat.png';
                          providerId = 2;
                        } else if (smartfren.contains(code)) {
                          provider = 'assets/smartfren.png';
                          providerId = 4;
                        } else {
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              AutoSizeText(
                "Pulsa: ${state.products?.data?[index].balance}",
                style: const TextStyle(
                  fontSize: 12.0,
                  color: CustomColors.black,
                ),
